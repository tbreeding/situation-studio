...
| 1 — Data model and recovery design      | Complete                                  | PostgreSQL 16 production is at all 15 forward migrations. The disposable migration/restore and invariant evidence remains in `docs/database-publication-checkpoint-1.md`.                                                                                                                                                                                      |
